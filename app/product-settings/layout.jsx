import { ProductSettingsBubbleNav } from "@/components/product-settings-bubble-nav";

export default function ProductSettingsLayout({ children }) {
  return (
